...
const PresevationForn = () => {
  return (
   ...
   <select className="px-10 py-0.5 bg-transparent rounded-lg outline-none font-bold text-[17px] text-white border-[2.2px] border-gray-100" name="people" id="people">
...
export default PresevationForn