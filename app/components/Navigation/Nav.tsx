...
<button className='px-6 py-2 sm:px-8 sm:py-3 text-[14px] sm:text-[16px} bg-blue-950 tranistion-all duration-200 hover:bg-red-600 flex items-center rounded-md space-x-2 text-white'>
  <span>
    <BiCycling className='w-[1.3rem] h-[1.3rem] sm:w-[1.7rem] sm:h-[1.7]'/>
  </span>
...
<button className='sm:px-6 sm:py-3 px-4 py-2 hover:bg-green-700 transition-all duration-200 bg-orange-600 flex items-center rounded-md text-white'>
  <BiShoppingBag className='w-[1.3rem] h-[1.3rem] sm:w-[1.7rem] sm:h-[1.7]'/>
</button>
<HiBars3BottomRight
onClick={openNav}
