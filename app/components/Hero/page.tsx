...
import BurgerImage1 from "@/public/image.number1.jpg";
import BurgerImage2 from "@/public/image.number2.jpg"
...
const Hero = () => {
  return (<Carousel additionalTransfrom={0} arrows={false} autoPlay={true} autoPlaySpeed={4000} centerMode={false} infinite responsive={responsive} itemClass='item' showDots={true}>
{/*1st hero slide*/}
<div className='w-[100%] h-[88vh] flex items-center justify-center flex-col bg-blue-950 md:clip_path'>
  <div className='w-[80%] grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-[2rem] mx:auto'>
    ...
    <div>
      ...
      <button className='mt-[2rem]  px-8 py-3 text-[16px] bg-green-500 tranistion-all duration-200 hover:bg-green-700 flex items-center rounded-md space-x-2 text-white'>
  <span>
...
<div className='w-[100%] h-[88vh] flex items-center justify-center flex-col bg-red-950 md:clip_path'>
  <div className='w-[80%] grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-[2rem] mx:auto'>
    ...
    {/*information*/}
    <div>
      <h1 className='text-[40px] font-semibold text-yellow-400'>Taste Burger</h1>
      <h1 className='text-[90px] leading-[5rem] uppercase text-white font-bold'>Top<br/>Burger</h1>
      <button className='mt-[2rem]  px-8 py-3 text-[16px] bg-blue-500 tranistion-all duration-200 hover:bg-green-700 flex items-center rounded-md space-x-2 text-white'>
  <span>
    <BiCycling className='w-[1.3rem] h-[1.3rem]'/>
  </span>
  <span className='font-bold'>Order Now</span>
